...
def find_optimal_parameters():
    # Script untuk mencari parameter optimal
    ...
    if not successful_params:
        print("Tidak ada kombinasi parameter yang memenuhi target.")
    else:
        print(f"Ditemukan {len(successful_params)} kombinasi parameter optimal:")
